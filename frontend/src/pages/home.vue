...
.home-hero { background: linear-gradient(135deg,#001a0f,#000); color: #fff; }
.hero { padding: 6rem 0; }
...
h1 { font-size: 2.25rem; margin: 1rem 0; background: linear-gradient(90deg,#00ff9d,#00cc7a); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
...
.feature-box { background: rgba(0,255,157,0.06); padding: 2rem; border-radius: 16px; border: 1px solid rgba(0,255,157,0.08); }
